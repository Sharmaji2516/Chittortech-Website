# Dedicated Git Status & Sync Script for Chittortech-Website
# Target GitHub Repository: https://github.com/Sharmaji2516/Chittortech-Website.git

$projectName = "Chittortech-Website"
$targetRemote = "https://github.com/Sharmaji2516/Chittortech-Website.git"
