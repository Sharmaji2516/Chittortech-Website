 ...
 * Includes automatic fallback for testing mode before domain verification.
 */
export async function dispatchEmail({ from, to, subject, html, attachments = [] }) {
  ...
  try {
    ...
    const defaultFrom = process.env.RESEND_FROM_EMAIL || 'ChittorTech <onboarding@resend.dev>';
