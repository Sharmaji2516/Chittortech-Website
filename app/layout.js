...
export const metadata = {
  ...
  title: {
    default: "ChittorTech | Premier Offshore IT Agency – Web, Mobile & AI Development India",
    template: "%s | ChittorTech – India's #1 Offshore Software Development Agency"
  },
  description: "ChittorTech is India's leading offshore IT agency for clients in the USA, UK, Canada, UAE, Australia & Europe. We build premium websites (Next.js/React), mobile apps (React Native/Kotlin), custom AI chatbots (OpenAI/Groq), SaaS platforms, and e-commerce systems. iStart Rajasthan approved startup. Hire dedicated developers today.",
  ...
  keywords: [
    ...
    // --- International Offshore IT Outsourcing Keywords ---
    "Offshore web development agency India",
    "Hire Next.js developers USA",
    "Hire React developers UK",
    "Outsource web development India",
    "Offshore software development company India",
    "React Native app development outsourcing India",
    "Outsource React Native mobile app UK",
    "Outsource mobile app development Canada",
    "Custom AI chatbot development Dubai UAE",
    "AI development company India for USA clients",
    "SaaS development company India Canada",
    "SaaS MVP development outsourcing India",
    "Dedicated developer hiring India",
    "Dedicated developer hiring Australia",
    "Hire dedicated React Native developer India",
    "Staff augmentation services India",
    "Remote software team India USA",
    "Top software outsourcing company India",
    "Top software outsourcing company Rajasthan",
    "Best offshore IT company India 2025",
    "Next.js development agency for USA clients",
    "Web development agency for startups USA UK",
    "Affordable web development for USA businesses",
    "India IT company for Dubai clients",
    "India software agency for Australia clients",
    "India web development for Germany clients",
    "India IT outsourcing for Singapore clients",
    "Best Indian IT company for international clients",
    "Budget web development USA UK Canada",
    "Cost-effective software development India",
  ],
  ...
  alternates: {
    ...
    languages: {
      ...
      "en": "https://www.chittortech.online",
    }
  },
  openGraph: {
